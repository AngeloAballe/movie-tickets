...
<spring:url value="/movieSchedule/${movieSchedule.id}/update" var="movieScheduleUrl"/>
<form:form action="${movieScheduleUrl}" method="post" modelAttribute="movieSchedule">
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">Edit Movie Schedule ${movieSchedule.id}</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <div class="box-body">
